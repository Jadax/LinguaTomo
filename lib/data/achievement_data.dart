...
final achievements = <AchievementDefinition>[
  ...
  AchievementDefinition(
    ...
    emoji: '\u{2B50}',
    requirement: 'Pass 5 word lessons (3 out of 5 or better).',
    rewardType: AchievementRewardType.trophy,
    reward: 'Bronze star',
    progress: (s) => s.wordLessonsCompleted,
    target: 5,
  ...
  AchievementDefinition(
    ...
    title: 'Hat trick',
    emoji: '\u{1F3A9}',
    requirement: 'Score 100% on 3 word lessons.',
    rewardType: AchievementRewardType.leoReaction,
    reward: 'Magic hat toss',
    progress: (s) => s.perfectLessons,
    target: 3,
  ),
  AchievementDefinition(
    ...
    emoji: '\u{2728}',
    requirement: 'Pass 25 word lessons.',
    rewardType: AchievementRewardType.trophy,
    reward: 'Gold star',
    progress: (s) => s.wordLessonsCompleted,
    target: 25,
  ...
  AchievementDefinition(
    ...
    title: 'Flawless Five',
    emoji: '\u{1F4AF}',
    requirement: 'Score 100% on 5 word lessons.',
    rewardType: AchievementRewardType.nestItem,
    reward: 'Golden book',
    progress: (s) => s.perfectLessons,
    target: 5,
