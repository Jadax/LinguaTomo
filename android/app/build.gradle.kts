...
android {
    namespace = "com.astraiva.linguatomo"
    ...
    defaultConfig {
        applicationId = "com.astraiva.linguatomo"
    ...
    buildTypes {
        release {
            // Local release builds stay frictionless. Store distribution requires
            // android/key.properties and an external keystore, both ignored by Git.
